...
!  byte_rat(): rational_t from integer

elemental type( rational_t) function byte_rat( i, j)

integer( kind= byte_k), intent( in) :: i                            ! byte integer

integer( kind= byte_k), optional, intent( in) :: j                  ! byte integer
...
continue                                                             ! rat()
   ...
   number_of_args: if( present( j) )then
      ...
      byte_rat = rational_t( int( i, kind= int_k), int( j, kind= int_k))

   else number_of_args

      byte_rat = rational_t( int( i, kind= int_k), 1_int_k)
...
!  short_rat(): rational_t from integer

elemental type( rational_t) function short_rat( i, j)

integer( kind= short_k), intent( in) :: i                            ! short integer

integer( kind= short_k), optional, intent( in) :: j                  ! short integer
...
continue                                                             ! rat()
   ...
   number_of_args: if( present( j) )then
      ...
      short_rat = rational_t( int( i, kind= int_k), int( j, kind= int_k))

   else number_of_args

      short_rat = rational_t( int( i, kind= int_k), 1_int_k)
...
end function short_rat

! **********************************************************************

!  int_rat(): rational_t from integer

elemental type( rational_t) function int_rat( i, j)

integer( kind= int_k), intent( in) :: i                            ! int integer
...
continue                                                             ! rat()
   ...
   number_of_args: if( present( j) )then
      ...
      int_rat = rational_t( int( i, kind= int_k), int( j, kind= int_k))

   else number_of_args

      int_rat = rational_t( int( i, kind= int_k), 1_int_k)
...
!  long_rat(): rational_t from integer

elemental type( rational_t) function long_rat( i, j)

integer( kind= long_k), intent( in) :: i                            ! long integer

integer( kind= long_k), optional, intent( in) :: j                  ! long integer
...
continue                                                             ! rat()
   ...
   number_of_args: if( present( j) )then
      ...
      long_rat = rational_t( int( i, kind= int_k), int( j, kind= int_k))

   else number_of_args

      long_rat = rational_t( int( i, kind= int_k), 1_int_k)
