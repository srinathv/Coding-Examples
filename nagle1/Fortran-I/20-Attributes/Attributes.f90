...
!  write diagnostic information about arrays
!  compiles with
...
character( len= *), parameter :: rcs_id = &
   '$Id: Attributes.f90,v 1.1 2012/05/22 18:17:05 dnagle Exp $'
...
character( len= *), parameter :: values_fmt = '( a, 1x, 5i5)'

!  declare an integer array of size five

   integer, dimension( 5), save :: integers = [ 1, 2, 3, 4, 5 ]

!  declare a second integer array of size five

   integer, dimension( -2: 2) :: second
...
!  assign some values to second

   second = integers - 3

!  write the new value of the target

   write( unit= output_unit, fmt= inquiry_fmt) 'the size is', size( integers)

   write( unit= output_unit, fmt= inquiry_fmt) 'the lower bound of integers is', lbound( integers)

   write( unit= output_unit, fmt= inquiry_fmt) 'the upper bound of integers is', ubound( integers)

   write( unit= output_unit, fmt= inquiry_fmt) 'the lower bound of second is', lbound( second)

   write( unit= output_unit, fmt= inquiry_fmt) 'the upper bound of second is', ubound( second)

!  write the new value of the target

   write( unit= output_unit, fmt= values_fmt) 'the values of integers are', integers

   write( unit= output_unit, fmt= values_fmt) 'the values of second are', second
