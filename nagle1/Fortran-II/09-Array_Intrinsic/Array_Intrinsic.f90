...
!  write diagnostic information about array merge
!  compiles with
...
character( len= *), parameter :: rcs_id = &
   '$Id: Array_Intrinsic.f90,v 1.1 2012/05/23 15:25:59 dnagle Exp $'
...
!    write all elements
   write( unit= output_unit, fmt=  '( "a10( :) ", ( 10 i4))') a10

!    write all elements
   write( unit= output_unit, fmt=  '( "merge( a, a10, iand( a, 1) == iand( a10, 1)) ", ( 10 i3))') &
      merge( a, a10, iand( a, 1) == iand( a10, 1))
