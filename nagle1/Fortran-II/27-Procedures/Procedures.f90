...
!-------------------------------------------
! Simple use of subroutine which calculates
! average of an array of numbers
!-------------------------------------------
subroutine ave( x, n, average)
implicit none
! dummy variable (locations are
integer :: n
! dummy variable  in main prog.)
real :: x(n), average
! local variable
   integer :: i
! local variable
...
character( len= *), parameter :: rcs_id = &
   '$Id: Procedures.f90,v 1.1 2012/05/23 15:33:38 dnagle Exp $'
...
!  identify the compiler and options
   ...
   call ave( x, n, average)
   write( unit= output_unit, fmt= '( a, es20.10)') 'Average is: ', average
