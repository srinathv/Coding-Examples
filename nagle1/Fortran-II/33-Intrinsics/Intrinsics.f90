...
character( len= *), parameter :: rcs_id = &
   '$Id: Intrinsics.f90,v 1.1 2012/05/23 15:35:38 dnagle Exp $'
...
!  write the functions
   ...
   write( unit= output_unit, fmt=  '( a, f12.4)') 'the overall sum: ', sum( anm)
   write( unit= output_unit, fmt=  '( a, f12.4)') 'the overall product: ', product( anm)
   write( unit= output_unit, fmt=  '( a, f12.4)') 'the overall minimum: ', minval( anm)
   write( unit= output_unit, fmt=  '( a, f12.4)') 'the overall maximum: ', maxval( anm)

   write( unit= output_unit, fmt=  '( a, 7f8.4)') 'the dim= 1 sum: ', sum( anm, dim= 1)
   write( unit= output_unit, fmt=  '( a, 7f8.4)') 'the dim= 1 product: ', product( anm, dim= 1)
   write( unit= output_unit, fmt=  '( a, 7f8.4)') 'the dim= 1 minimums: ', minval( anm, dim= 1)
   write( unit= output_unit, fmt=  '( a, 7f8.4)') 'the dim= 1 maximums: ', maxval( anm, dim= 1)

   write( unit= output_unit, fmt=  '( a, 5f8.4)') 'the dim= 2 sum: ', sum( anm, dim= 2)
   write( unit= output_unit, fmt=  '( a, 5f8.4)') 'the dim= 2 product: ', product( anm, dim= 2)
   write( unit= output_unit, fmt=  '( a, 5f8.4)') 'the dim= 2 minimums: ', minval( anm, dim= 2)
   write( unit= output_unit, fmt=  '( a, 5f8.4)') 'the dim= 2 maximums: ', maxval( anm, dim= 2)
