C***********************************************************************
C                                                                      *
C    GAUSSIAN ELIMINATION WITH PARTIAL PIVOTING ALGORITHM 6.2          *
C                                                                      *
C***********************************************************************
C
C
...
C
C     INITIALIZATION
      DIMENSION A(10,11),NROW(10),X(10)
      CHARACTER NAME*30,NAME1*30,AA*1
      INTEGER INP,OUP,FLAG
      LOGICAL OK
      OPEN(UNIT=5,FILE='CON',ACCESS='SEQUENTIAL')
      OPEN(UNIT=6,FILE='CON',ACCESS='SEQUENTIAL')
      WRITE(6,*) 'This is Gaussian Elimination with '
...
11    IF ( .NOT. OK) GOTO 400
      ...
      ELSE
         OUP = 6
      ENDIF
      WRITE(OUP,*) 'GAUSSIAN ELIMINATION WITH PARTIAL PIVOTING'
...
C     STEP 11
      DO 60 K=1,NN
           ...
           SUM=0.0
           DO 70 KK=JJ,N
70         SUM=SUM-A(N2,KK)*X(KK)
60    X(I)=(A(N2,N+1)+SUM)/A(N2,I)
C     STEP 12
C     PROCEDURE COMPLETED SUCCESSFULLY
      WRITE(OUP,6)
      WRITE(OUP,13) ((A(I,J),J=1,N),I=1,N)
